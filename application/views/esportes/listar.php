...
<div id="conteudo" class="">
	...
	================================================== -->
		...
		<div class="resultado_pesquisa">
            ...
            <?php } else { ?>
                <?php echo image_thumb('uploads/logos/' . $esporte->logo_esporte, 366, 267, '', 'logo_resultado_pesquisa'); ?>
            <?php } ?>

	        <h3 class="estabelecimento_resultado_pesquisa"><?php echo $esporte->nome_esporte; ?></h3>
	        <p class="esporte_resultado_pesquisa">Local: <?php echo $esporte->ds_bairro_nome; ?></p>
