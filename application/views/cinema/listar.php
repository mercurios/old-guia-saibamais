...
<div id="conteudo" class="">
	...
	================================================== -->
		...
		<div class="resultado_pesquisa">
        	...
        	<?php } else { ?>
        		<?php echo image_thumb('uploads/logos/' . $cinema->logo_cinema, 366, 267, '', 'logo_resultado_pesquisa'); ?>
        	<?php } ?>
        ...
        <div id="filtrar_ordenar">
			<div id="filtrar_pesquisa" class="select">
				<div id="topo_select_filtrar"></div>
                    ...
                    <select id="filtro_adaptado_cinema">
