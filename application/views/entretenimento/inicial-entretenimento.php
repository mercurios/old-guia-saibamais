	...
	<div id="area_conteudo_esquerda" class="area_conteudo">
    	<div class="sliders-medium esquerda">
				<div class="cycle-slideshow" data-cycle-fx="fade" data-cycle-slides="div.item-slider" data-cycle-overlay-template="{{title}}">
					...
					<div class="item-slider" data-title="<?php echo $entre_s->titulo_chamada; ?>">
						<a href="<?php echo $entre_s->link_chamada; ?>" title="<?php echo $entre_s->titulo_chamada; ?>">
							<img src="tim.php?src=<?php echo base_url('uploads/chamadas') . '/' . $entre_s->img_chamada; ?>&w=326&h=250" alt="<?php echo $entre_s->titulo_chamada; ?>" />
						</a>
					</div>
			...
			<div class="chamadas direita">
				...
				<div class="chamada_pequena">
					<a href="<?php echo $entre_p_top->link_chamada; ?>" title="<?php echo $entre_p_top->titulo_chamada; ?>">
						<img src="tim.php?src=<?php echo base_url('uploads/chamadas') . '/' . $entre_p_top->img_chamada; ?>&w=99&h=77" alt="<?php echo $entre_p_top->titulo_chamada; ?>" class="img_chamada_pequena"/>
                        <p><?php echo $entre_p_top->desc_chamada; ?></p>
					</a>
				</div>
			...
			<div class="chamada-horizontal">
				...
				<div class="chamada_media">
					<a href="<?php echo $entre_m->link_chamada; ?>" title="<?php echo $entre_m->titulo_chamada; ?>">
						<img src="tim.php?src=<?php echo base_url('uploads/chamadas') . '/' . $entre_m->img_chamada; ?>&w=154&h=102" alt="<?php echo $entre_m->titulo_chamada; ?>" class="img_chamada_media"/>
						<h2><?php echo $entre_m->titulo_chamada; ?></h2>
						<p><?php echo $entre_m->desc_chamada; ?></p>
					</a>
				</div>
			...
			<div class="sliders-grande direita">
				<div class="cycle-slideshow" data-cycle-fx="fade" data-cycle-slides="div.item-slider" data-cycle-overlay-template="{{title}}">
				<?php
					if (isset($chamada_entre_s_f)) {
						foreach ($chamada_entre_s_f as $entre_s_f) {
					?>
					...
					<div class="item-slider" data-title="<?php echo $entre_s_f->titulo_chamada; ?>">
						<a href="<?php echo $entre_s_f->link_chamada; ?>" title="<?php echo $entre_s_f->titulo_chamada; ?>">
							<img src="tim.php?src=<?php echo base_url('uploads/chamadas') . '/' . $entre_s_f->img_chamada; ?>&w=670&h=200" alt="<?php echo $entre_s_f->titulo_chamada; ?>" />
						</a>
					</div>
           ...
           <div class="chamada-horizontal">
                ...
                <div class="chamada_pequena">
                    <a href="<?php echo $entre_p_bot->link_chamada; ?>" title="<?php echo $entre_p_bot->titulo_chamada; ?>">
                        <img src="tim.php?src=<?php echo base_url('uploads/chamadas') . '/' . $entre_p_bot->img_chamada; ?>&w=99&h=77" alt="<?php echo $entre_p_bot->titulo_chamada; ?>" class="img_chamada_pequena"/>
                        <p><?php echo $entre_p_bot->desc_chamada; ?></p>
                    </a>
                </div>
                <?php
                    }
        	...
        	<div class="chamada-captions">
        		<img src="tim.php?src=<?php echo base_url('uploads/chamadas') . '/' . $entre_m_p->img_chamada; ?>&w=154&h=168" alt="<?php echo $entre_m_p->titulo_chamada; ?>"/>
            ...
            <div class="chamadas_sidebar_direita">
            	...
            	<div class="chamada-captions-grande">
            		<img src="tim.php?src=<?php echo base_url('uploads/chamadas') . '/' . $entre_m_f->img_chamada; ?>&w=343&h=370" alt="<?php echo $entre_m_f->titulo_chamada; ?>"/>
	            	<span>
