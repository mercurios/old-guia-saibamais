...
<div id="conteudo" class="">
	...
	================================================== -->
		<?php 
		if (count($conteudo) != 0) {
			foreach ($conteudo as $show) {
		?>

		<div class="resultado_pesquisa">
			<img src="<?php echo base_url('tim.php?src=uploads/logos/'. $show->logo_show .'&w=240&h=146'); ?>" alt="logo" class="logo_resultado_pesquisa" />
	    ...
	    <?php
			...
			echo 'Ops! Ainda não tem shows cadastrados nessa categoria.';
		}
		?>
	</div><!-- /listar-all -->
        ...
        <div id="filtrar_ordenar">
			<div id="filtrar_pesquisa" class="select">
				<select id="filtro_local_show">
                    ...
                    <select id="filtro_adaptado_show">
