		...
		<div id="area_conteudo_superior"><!-- /inicio da area de conteudo superior -->
			<div id="topo_pagina_anunciante" class="">
				<div id="redes_sociais_pagina">
					<ul>
						<li><a href="<?php echo $show->flickr_show; ?>" target="_blank" title="Flickr"><img src="<?php echo base_url('assets'); ?>/images/flickr_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $show->insta_show; ?>" target="_blank" title="Instagram"><img src="<?php echo base_url('assets'); ?>/images/instagram_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $show->youtube_show; ?>" target="_blank" title="Youtube"><img src="<?php echo base_url('assets'); ?>/images/youtube_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $show->orkut_show; ?>" target="_blank" title="Orkut"><img src="<?php echo base_url('assets'); ?>/images/orkut_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $show->googleplus_show; ?>" target="_blank" title="Google Plus"><img src="<?php echo base_url('assets'); ?>/images/gplus_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $show->twitter_show; ?>" target="_blank" title="Twitter"><img src="<?php echo base_url('assets'); ?>/images/twitter_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $show->facebook_show; ?>" target="_blank" title="Facebook"><img src="<?php echo base_url('assets'); ?>/images/facebook_icon.jpg" alt="RS" /></a></li>
					</ul>
				</div>
				<div id="logo_topo_pagina_anunciante" class="">
					<?php if (empty($show->logo_show)) { ?>
						<img src="<?php echo base_url('tim.php?src=uploads/logos/default.jpg&w=366&h=267'); ?>" alt="" />
					<?php } else { ?>
						<img src="<?php echo base_url('tim.php?src=uploads/logos/'. $show->logo_show .'&w=366&h=267'); ?>" alt="" />
					<?php } ?>
					<h3><?php echo $show->nome_show ?></h3>
				</div>
				<div id="contatos_pagina">
					<div class="contatos_pagina">
						<h4 class="titulo_contatos_pagina">Telefone:</h4>
						<h6><?php echo $show->fone_show ?></h6>
					</div>
					<div class="contatos_pagina">
						<h4  class="titulo_contatos_pagina">Site:</h4>
						<h6><?php echo $show->site_show ?></h6>
					</div>
					<div class="contatos_pagina">
						<h4 class="titulo_contatos_pagina">E-mail:</h4>
						<h6><?php echo $show->email_show ?></h6>
					</div>
				</div>
			</div>
		...
		<div id="area_conteudo_esquerda"><!-- /inicio da area de conteudo esquerda -->  
			...
			<div id="descricao_pagina_grande" class="w-grande">
				<div class="topo_area_pagina">
					...
					<p class="texto_pagina"> <?php echo $show->desc_show ?></p>
			</div>
			...
			<div id="informacoes_pagina" >
				...
				<div class="informacoes_pagina">
					<h4>Data(s):</h4> 
					<h6><?php echo $show->data_show ?></h6>
				</div>

				<div class="informacoes_pagina">
					<h4>Preço(s):</h4> 
					<div class="precos_informacoes_pagina">
						<h6><?php echo $show->titulo_preco_um ?></h6>
						<p>R$ <?php echo $show->val_preco_um ?></p>
					</div>
					<div class="precos_informacoes_pagina">
						<h6><?php echo $show->titulo_preco_dois ?></h6>
						<p>R$ <?php echo $show->val_preco_dois ?></p>
					</div>
					<div class="precos_informacoes_pagina">
						<h6><?php echo $show->titulo_preco_tres ?></h6>
						<p>R$ <?php echo $show->val_preco_tres ?></p>
					</div>
				</div>
				<div class="informacoes_pagina">
					<h4>Horário(s):</h4> 
					<h6>Das <?php echo $show->horario_show ?></h6>
				</div>
				...
				<div class="informacoes_pagina_pagamento">
					...
					<div class="formas_pagamento">
						<?php $pagamento = explode(',', $show->pag_show);
