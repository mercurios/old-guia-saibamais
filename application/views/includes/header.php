        ...
        <div id="container">
           ...
           <div id="topo">
				<div class="conteudo">
					...
					<div id="logo">
						<a href="<?php echo base_url(); ?>" title="Clicando aqui você vai para a página inicial"><img src="<?php echo base_url('assets'); ?>/images/logo2.png" alt="Logo"/></a>
					</div>
						...
						<div id="menu_entretenimento" class="menus">
							...
							<div id="" class="sub_menu">
								...
								<ul>
									...
									<li class="sub_menus"><a href="<?php echo base_url('exposicoes'); ?>" title="Veja as exposições estão acontecendo">Exposições</a></li>
									<li class="sub_menus"><a href="<?php echo base_url('feira-e-eventos'); ?>" title="Veja as feiras e eventos que estão acontecendo">Feiras e eventos</a></li>
									<li class="sub_menus"><a href="<?php echo base_url('shows'); ?>" title="Veja onde tem shows para você">Shows</a></li>
									<li class="sub_menus"><a href="<?php echo base_url('teatros'); ?>" title="Veja os teatros e as peças que estão em exibição">Teatros</a></li>
								</ul>
							</div>
							<span class="ou">ou</span>
							<div id="" class="sub_menu">
