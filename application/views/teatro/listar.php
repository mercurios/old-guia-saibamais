...
<div id="conteudo" class="">
	...
	================================================== -->
		<?php 
		if (count($conteudo) != 0) {
			foreach ($conteudo as $teatro) {
		?>

		<div class="resultado_pesquisa">
			<img src="<?php echo base_url('tim.php?src=uploads/logos/'. $teatro->logo_teatro .'&w=240&h=146'); ?>" alt="logo" class="logo_resultado_pesquisa" />
	    ...
	    <?php
			...
			echo 'Ops! Ainda não tem teatros cadastrados nessa categoria.';
		}
		?>
	</div><!-- /listar-all -->
        ...
        <div id="filtrar_ordenar">
			<div id="filtrar_pesquisa" class="select">
				<div id="topo_select_filtrar"></div>
                    ...
                    <select id="filtro_adaptado_teatro">
