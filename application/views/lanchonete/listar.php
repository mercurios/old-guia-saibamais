	...
	<div class="conteudo">
		...
		================================================== -->
			...
			<div class="resultado_pesquisa">
				<?php if (empty($lanchonete->logo_lanchonete)) { echo image_thumb('uploads/logos/default.jpg', 240, 146, '', 'logo_resultado_pesquisa', ''); } else { echo image_thumb('uploads/logos/' . $lanchonete->logo_lanchonete, 240, 146, '', 'logo_resultado_pesquisa', ''); } ?>
