...
<div id="conteudo" class="">
	<div class="conteudo">
		<?php foreach ($conteudo as $evento) : ?>
		<div id="area_conteudo_superior"><!-- /inicio da area de conteudo superior -->
			<div id="topo_pagina_anunciante" class="">
				<div id="redes_sociais_pagina">
					<ul>
						<li><a href="<?php echo $evento->flickr_evento; ?>" target="_blank" title="Flickr"><img src="<?php echo base_url('assets'); ?>/images/flickr_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $evento->insta_evento; ?>" target="_blank" title="Instagram"><img src="<?php echo base_url('assets'); ?>/images/instagram_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $evento->youtube_evento; ?>" target="_blank" title="Youtube"><img src="<?php echo base_url('assets'); ?>/images/youtube_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $evento->orkut_evento; ?>" target="_blank" title="Orkut"><img src="<?php echo base_url('assets'); ?>/images/orkut_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $evento->googleplus_evento; ?>" target="_blank" title="Google Plus"><img src="<?php echo base_url('assets'); ?>/images/gplus_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $evento->twitter_evento; ?>" target="_blank" title="Twitter"><img src="<?php echo base_url('assets'); ?>/images/twitter_icon.jpg" alt="RS" /></a></li>
						<li><a href="<?php echo $evento->facebook_evento; ?>" target="_blank" title="Facebook"><img src="<?php echo base_url('assets'); ?>/images/facebook_icon.jpg" alt="RS" /></a></li>
					</ul>
				</div>
				<div id="logo_topo_pagina_anunciante" class="">
					...
					<?php } else { ?>
						<img src="<?php echo base_url('tim.php?src=uploads/logos/'. $evento->logo_evento .'&w=366&h=267'); ?>" alt="" />
					<?php } ?>
				...
				<div id="contatos_pagina">
					<div class="contatos_pagina">
						...
						<h6><?php echo $evento->fone_evento ?></h6>
					</div>
					<div class="contatos_pagina">
						<h4  class="titulo_contatos_pagina">Site:</h4>
						<h6><?php echo $evento->site_evento ?></h6>
					</div>
					<div class="contatos_pagina">
						<h4 class="titulo_contatos_pagina">E-mail:</h4>
						<h6><?php echo $evento->email_evento ?></h6>
					</div>
				</div>
			</div>
		...
		<div id="area_conteudo_esquerda"><!-- /inicio da area de conteudo esquerda -->  
			...
			<div id="descricao_pagina_grande" class="w-grande">
				<div class="topo_area_pagina">
					...
					<p class="texto_pagina"> <?php echo $evento->desc_evento ?></p>
			</div>
			...
			<div id="informacoes_pagina" >
				...
				<div class="informacoes_pagina">
					<h4>Data(s):</h4> 
					<h6><?php echo $evento->data_evento ?></h6>
				</div>

				<div class="informacoes_pagina">
					<h4>Preço(s):</h4> 
					<div class="precos_informacoes_pagina">
						<h6><?php echo $evento->titulo_preco_um ?></h6>
						<p>R$ <?php echo $evento->val_preco_um ?></p>
					</div>
					<div class="precos_informacoes_pagina">
						<h6><?php echo $evento->titulo_preco_dois ?></h6>
						<p>R$ <?php echo $evento->val_preco_dois ?></p>
					</div>
					<div class="precos_informacoes_pagina">
						<h6><?php echo $evento->titulo_preco_tres ?></h6>
						<p>R$ <?php echo $evento->val_preco_tres ?></p>
					</div>
				</div>
				<div class="informacoes_pagina">
					<h4>Horário(s):</h4> 
					<h6>Das <?php echo $evento->horario_evento ?></h6>
				</div>
				...
				<div class="informacoes_pagina_pagamento">
					...
					<div class="formas_pagamento">
						<?php $pagamento = explode(',', $evento->pag_evento);
