                ...
                <div class="widget-content">
                    ...
                    if (isset($_POST['sendCliente'])) {
                        ...
                        if ($verifica['erro']){
                            ...
                            // Grava no banco
                            $save = create('guia_restaurantes', $dados);

                            // Verifica se foi gravado com sucesso
                            if ($save) {
                                message('<strong>Restaurante adicionado com sucesso.</strong>', 'success');
                            }
                            else {
                                message('<strong>Erro ao cadastrar restaurante, tente novamente.</strong>', 'warning');
                            }
                        }
                    }
                    ?>
                	...
                	<form name="cadCliente" method="post" action="" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="span3">
                                <label><strong>Logo do restaurante:</strong></label>
