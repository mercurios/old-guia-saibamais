                    ...
                    <div class="widget-content">
                        ...
                        if (isset($_POST['sendExpo'])) {
                            ...
                            if ($verifica['erro']){
                                ...
                                $save = create('guia_feiraeventos', $dados);

                                if ($save) {
                                    message('Evento cadastrada com sucesso.', 'success');
                                    salvaLog("Adicionou um novo evento.", $_SESSION['autUser']['nome_user']);
                                }
                                else {
                                    message('Erro ao cadastrar Evento.', 'warning');
                                }
                            }
                        }
                        ?>
                    	...
                    	<form name="addExpo" method="post" action="" enctype="multipart/form-data">
							...
							<div class="span11">
                				...
                				<input type="text" name="nome" value="" class="input-block-level" placeholder="Nome da Evento" />
                			</div>

                			<div class="span11">
                				<label><strong>Descrição:</strong></label>
                				<textarea name="descricao" class="input-block-level" placeholder="Descrição da Evento"></textarea>
                			</div>
							...
							<div class="span11">
                            	<input type="submit" name="sendExpo" value="Cadastrar Evento" class="btn btn-success pull-right" />
                            </div>
                    	</form>
                    </div><!-- /widget-content -->
                </div><!-- /widget -->
