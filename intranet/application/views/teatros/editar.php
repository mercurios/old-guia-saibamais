<div class="row">
	<form name="newRestaurante" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('teatros/update') ?>">
		<div class="span12">
			<div class="widget">
				<div class="widget-head">
					<div class="pull-left"><i class="icon-plus"></i> Cadastrar teatro</div>
				...
				<div class="widget-content padding-left-35">
					<div class="padd">
						<?php if (!empty($teatro)) { foreach ($teatro as $res) { ?>
						<div class="row">
							<div class="span11">
							...
							<div class="span2">
								<span class="thumbnail">
									<?php echo $this->biblioteca->image_thumb('../uploads/logos/' . $res->logo_teatro, 250, 200 ); ?>
								</span>
							</div>
							...
							<div class="span3">
								...
								<input type="text" class="input-block-level" id="nome" name="nome" value="<?php echo $res->nome_teatro ?>" />	
							</div>

							<div class="span6">
								<label>Descrição: <span class="text-error">*</span><small><span class="text-error"><?php echo form_error('descricao'); ?></span></small></label>
								<textarea class="input-block-level" rows="5" name="descricao"><?php echo $res->desc_teatro ?></textarea>
							</div>
                            ...
                            <div class="span5">
                                <label>Twitter:</label>
                                <input class="input-block-level" name="twitter" type="text" value="<?php echo $res->twitter_teatro ?>" />
                            </div>

                            <div class="span6">
                                <label>Facebook:</label>
                                <input class="input-block-level" name="facebook" type="text" value="<?php echo $res->facebook_teatro ?>" />
                            </div>

                            <div class="span5">
                            	</br>
                                <label>Youtube:</label>
                                <input class="input-block-level" name="youtube" type="text" value="<?php echo $res->youtube_teatro ?>" />
                            </div>

                            <div class="span6">
                            	</br>
                                <label>Instagram:</label>
                                <input class="input-block-level" name="instagram" type="text" value="<?php echo $res->insta_teatro ?>" />
                            </div>

                            <div class="span5">
                            	</br>
                                <label>Flickr:</label>
                                <input class="input-block-level" name="flickr" type="text" value="<?php echo $res->flickr_teatro ?>" />
                            </div>

                            <div class="span6">
                            	</br>
                                <label>Google +:</label>
                                <input class="input-block-level" name="google" type="text" value="<?php echo $res->googleplus_teatro ?>" />
                            </div>

                            <div class="span11">
                            </br>
                                <label>Orkut:</label>
                                <input class="input-block-level" name="orkut" type="text" value="<?php echo $res->orkut_teatro ?>" />
                            </div>
                            ...
                            <div class="span5">
								...
								<select name="estado" class="input-block-level" id="estado">
									...
									<?php foreach ($estados as $estado) : ?>
										<option value="<?php echo $estado->cd_uf ?>" <?php echo ($res->uf_teatro == $estado->cd_uf) ? 'selected' : '' ?>><?php echo $estado->ds_uf_nome ?></option>
									<?php endforeach; ?>
								</select>
                            </div>
                            ...
                            <div class="span6">
								...
								<select name="cidade" class="input-block-level" id="cidade">
									...
									<?php foreach ($cidades as $cidade) : ?>
										<option value="<?php echo $cidade->cd_cidade ?>" <?php echo ($res->cidade_teatro == $cidade->cd_cidade) ? 'selected' : '' ?>><?php echo $cidade->ds_cidade_nome ?></option>
									<?php endforeach; ?>
								</select>
                            </div>
                            ...
                            <div class="span5">
								...
								<select name="bairro" class="input-block-level" id="bairro">
									...
									<?php foreach ($bairros as $bairro) : ?>
										<option value="<?php echo $bairro->cd_bairro ?>" <?php echo ($res->bairro_teatro == $bairro->cd_bairro) ? 'selected' : '' ?>><?php echo $bairro->ds_bairro_nome ?></option>
									<?php endforeach; ?>
								</select>
                            </div>
                            ...
                            <div class="span6">
								...
								<input type="text" name="rua" id="rua" value="<?php echo $res->rua_teatro ?>" class="input-block-level">
                            </div>
                            ...
                            <div class="span5">
								...
								<input type="text" name="numero" id="numero" value="<?php echo $res->num_teatro ?>" class="input-block-level">
                            </div>

                            <div class="span6">
                            	</br>
                            	<label for="cep">Cep: <span class="text-error">*</span> <small><span class="text-error"><?php echo form_error('cep'); ?></span></small></label>
								<input type="text" name="cep" id="cep" value="<?php echo $res->cep_teatro ?>" class="input-block-level maskCep">
                            </div>
                            ...
                            <div class="span5">
								...
								<input type="text" name="longitude" id="longitude" value="<?php echo $res->long_teatro ?>" class="input-block-level">
                            </div>
                            ...
                            <div class="span6">
								...
								<input type="text" name="latitude" id="latitude" value="<?php echo $res->lati_teatro ?>" class="input-block-level">
                            </div>
                            ...
                            <div class="span5">
                                ...
                                <input class="input-block-level maskTelefone" value="<?php echo $res->fone_teatro ?>" name="num_atendimento" type="text" placeholder="">
                            </div>

                            <div class="span6">
                                <label>E-mail:</label>
                                <input name="email" class="input-block-level" value="<?php echo $res->email_teatro ?>" name="email" type="text" placeholder="">
                            </div>

                            <div class="span11">
                            	</br>
                                <label>Site:</label>
                                <input name="site" class="input-block-level" value="<?php echo $res->site_teatro ?>" name="site" type="text">
                            </div>
							...
							<div class="span11">
								<?php $_categoria = explode(",", $res->categoria_teatro); ?>
							...
							<div class="span11">
								<?php $_formaPagamento = explode(",", $res->pag_teatro); ?>	
								<label class="checkbox inline">
                            ...
                            <div class="span11">
                            	<?php $_adaptado = explode(",", $res->adaptado_teatro); ?>
                                <label class="checkbox inline">
					...
					<div class="widget-foot">
						<input type="hidden" name="id" value="<?php echo $res->id_teatro ?>">
						<input type="hidden" name="imgAtual" value="<?php echo $res->logo_teatro ?>">
						<input type="submit" class="btn btn-success pull-right" name="cadastrar" value="Atualizar teatro" />
