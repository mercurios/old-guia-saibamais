<div class="row">
	<form name="newRestaurante" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('teatros/save') ?>">
		<div class="span12">
			<div class="widget">
				...
				<div class="widget-content padding-left-35">
					...
					<div class="widget-foot">
						<input type="submit" class="btn btn-success pull-right" name="cadastrar" value="Cadastrar teatro" />
