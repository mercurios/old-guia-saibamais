<div class="row">
	<form name="newRestaurante" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('shows/save') ?>">
		<div class="span12">
			<div class="widget">
				<div class="widget-head">
					<div class="pull-left"><i class="icon-plus"></i> Cadastrar show</div>
				...
				<div class="widget-content padding-left-35">
					<div class="padd">
						<div class="row">
							...
							<div class="span5">
								...
								<input type="text" class="input-block-level data" id="data" name="data" value="" />
							</div>

							<div class="span6">
								</br>
								<label for="horario">Horário: </label>
								<input type="text" class="input-block-level" id="horario" name="horario" value="" />
							</div>
					...
					<div class="widget-foot">
						<input type="submit" class="btn btn-success pull-right" name="cadastrar" value="Cadastrar show" />
