...
<div class="row">
	<form name="newRestaurante" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('pecas/save') ?>">
		<div class="span12">
			<div class="widget">
				<div class="widget-head">
					<div class="pull-left"><i class="icon-plus"></i> Cadastrar peça</div>
				...
				<div class="widget-content padding-left-35">
					<div class="padd">
						<div class="row">
                            ...
                            <div class="span11">
								...
								<input type="text" class="input-block-level" id="val_inteira" name="val_inteira" value="" />
							</div>

							<div class="span11">
								</br>
								<label for="val_meia">Valor meia entrada: </label>
								<input type="text" class="input-block-level" id="val_meia" name="val_meia" value="" />
							</div>
					...
					<div class="widget-foot">
						...
						<input type="submit" class="btn btn-success pull-right" name="cadastrar" value="Cadastrar peça" />
