<div class="row">
	<form name="edtlanchonete" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('lanchonetes/update') ?>">
		<div class="span12">
			<?php if (isset($msg)) : echo $msg; endif; ?>
			<div class="widget">
				<div class="widget-head">
					<div class="pull-left"><i class="icon-pencil"></i> Editar lanchonetes</div>
				...
				<div class="widget-content padding-left-35">
					<div class="padd">
						<?php if (!empty($lanchonete)) { foreach ($lanchonete as $res) : ?>
							<div class="row">
								<div class="span11">
								...
								<div class="span2">
									<span class="thumbnail">
										<?php echo $this->biblioteca->image_thumb('../uploads/logos/' . $res->logo_lanchonete, 250, 200 ); ?>
									</span>
								</div>
								...
								<div class="span3">
									...
									<input type="text" class="input-block-level" id="nome" name="nome" value="<?php echo $res->nome_lanchonete ?>" />	
								</div>

								<div class="span6">
									<label>Descrição: <span class="text-error">*</span><small><span class="text-error"><?php echo form_error('descricao'); ?></span></small></label>
									<textarea class="input-block-level" rows="5" name="descricao"><?php echo $res->desc_lanchonete ?></textarea>
								</div>
								...
								<div class="span11">
									...
									<select name="status" class="input-block-level">
										<option value="1" <?php echo ($res->status_lanchonete == 1) ? 'selected' : '' ?>>Ativo</option>
										<option value="0" <?php echo ($res->status_lanchonete == 0) ? 'selected' : '' ?>>Bloqueado</option>
									</select>
	                            </div>
	                            ...
	                            <div class="span5">
	                                <label>Twitter:</label>
	                                <input class="input-block-level" name="twitter" type="text" value="<?php echo $res->twitter_lanchonete ?>" />
	                            </div>

	                            <div class="span6">
	                                <label>Facebook:</label>
	                                <input class="input-block-level" name="facebook" type="text" value="<?php echo $res->facebook_lanchonete ?>" />
	                            </div>

	                            <div class="span5">
	                            	</br>
	                                <label>Youtube:</label>
	                                <input class="input-block-level" name="youtube" type="text" value="<?php echo $res->youtube_lanchonete ?>" />
	                            </div>

	                            <div class="span6">
	                            	</br>
	                                <label>Instagram:</label>
	                                <input class="input-block-level" name="instagram" type="text" value="<?php echo $res->insta_lanchonete ?>" />
	                            </div>

	                            <div class="span5">
	                            	</br>
	                                <label>Flickr:</label>
	                                <input class="input-block-level" name="flickr" type="text" value="<?php echo $res->flickr_lanchonete ?>" />
	                            </div>

	                            <div class="span6">
	                            	</br>
	                                <label>Google +:</label>
	                                <input class="input-block-level" name="google" type="text" value="<?php echo $res->googleplus_lanchonete ?>" />
	                            </div>

	                            <div class="span11">
	                            </br>
	                                <label>Orkut:</label>
	                                <input class="input-block-level" name="orkut" type="text" value="<?php echo $res->orkut_lanchonete ?>" />
	                            </div>
	                            ...
	                            <div class="span5">
									...
									<select name="estado" class="input-block-level" id="estado">
										...
										<?php foreach ($estados as $estado) : ?>
											<option value="<?php echo $estado->cd_uf ?>" <?php echo ($res->uf_lanchonete == $estado->cd_uf) ? 'selected' : '' ?>><?php echo $estado->ds_uf_nome ?></option>
										<?php endforeach; ?>
									</select>
	                            </div>
	                            ...
	                            <div class="span6">
									...
									<select name="cidade" class="input-block-level" id="cidade">
										...
										<?php foreach ($cidades as $cidade) : ?>
											<option value="<?php echo $cidade->cd_cidade ?>" <?php echo ($res->cidade_lanchonete == $cidade->cd_cidade) ? 'selected' : '' ?>><?php echo $cidade->ds_cidade_nome ?></option>
										<?php endforeach; ?>
									</select>
	                            </div>
	                            ...
	                            <div class="span5">
									...
									<select name="bairro" class="input-block-level" id="bairro">
										...
										<?php foreach ($bairros as $bairro) : ?>
											<option value="<?php echo $bairro->cd_bairro ?>" <?php echo ($res->bairro_lanchonete == $bairro->cd_bairro) ? 'selected' : '' ?>><?php echo $bairro->ds_bairro_nome ?></option>
										<?php endforeach; ?>
									</select>
	                            </div>
	                            ...
	                            <div class="span6">
									...
									<input type="text" name="rua" id="rua" value="<?php echo $res->rua_lanchonete ?>" class="input-block-level">
	                            </div>
	                            ...
	                            <div class="span5">
									...
									<input type="text" name="numero" id="numero" value="<?php echo $res->num_lanchonete ?>" class="input-block-level">
	                            </div>

	                            <div class="span6">
	                            	</br>
	                            	<label for="cep">Cep: <span class="text-error">*</span> <small><span class="text-error"><?php echo form_error('cep'); ?></span></small></label>
									<input type="text" name="cep" id="cep" value="<?php echo $res->cep_lanchonete ?>" class="input-block-level maskCep">
	                            </div>
	                            ...
	                            <div class="span5">
									...
									<input type="text" name="longitude" id="longitude" value="<?php echo $res->long_lanchonete ?>" class="input-block-level">
	                            </div>
	                            ...
	                            <div class="span6">
									...
									<input type="text" name="latitude" id="latitude" value="<?php echo $res->lati_lanchonete ?>" class="input-block-level">
	                            </div>
	                            ...
	                            <div class="span5">
	                                ...
	                                <input class="input-block-level maskTelefone" value="<?php echo $res->fone_atend_lanchonete ?>" name="num_atendimento" type="text" placeholder="">
	                            </div>

	                            <div class="span6">
	                                <label>Disk-Entrega:</label>
	                                <input class="input-block-level maskTelefone" value="<?php echo $res->fone_entrega_lanchonete ?>" name="num_entrega" type="text" placeholder="">
	                            </div>

	                            <div class="span5">
	                            	</br>
	                                <label>E-mail:</label>
	                                <input name="email" class="input-block-level" value="<?php echo $res->email_lanchonete ?>" name="email" type="text" placeholder="">
	                            </div>

	                            <div class="span6">
	                            	</br>
	                                <label>Site:</label>
	                                <input name="site" class="input-block-level" value="<?php echo $res->site_lanchonete ?>" name="site" type="text">
	                            </div>
								...
								<div class="span11">
									<?php $_formaPagamento = explode(",", $res->pag_lanchonete); ?>	
								...
								<div class="span11">
									<?php $_infoExtras = explode(",", $res->extra_lanchonete); ?>
									<label class="checkbox inline">
	                            ...
	                            <div class="span11">
	                            	<?php $_tipoLanchonete = explode(",", $res->tipo_lanchonete); ?>
	                                <label><strong>Tipo de lanchonete:</strong></label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoLanchonete[]" value="doces" <?php echo (in_array('doces', $_tipoLanchonete)) ? 'checked' : ''; ?>> Doces
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoLanchonete[]" value="gelados" <?php echo (in_array('gelados', $_tipoLanchonete)) ? 'checked' : ''; ?>> Gelados
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoLanchonete[]" value="massas" <?php echo (in_array('massas', $_tipoLanchonete)) ? 'checked' : ''; ?>> Massas 
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoLanchonete[]" value="especiais" <?php echo (in_array('especiais', $_tipoLanchonete)) ? 'checked' : ''; ?>> Light / Especiais
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoLanchonete[]" value="naturais" <?php echo (in_array('naturais', $_tipoLanchonete)) ? 'checked' : ''; ?>> Naturais
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoLanchonete[]" value="salgados" <?php echo (in_array('salgados', $_tipoLanchonete)) ? 'checked' : ''; ?>> Salgados
	                                </label>
	                            </div><!-- /span11 -->

	                            <div class="span11">
	                            	<?php $_tipoComida = explode(",", $res->tipo_comida_lanchonete); ?>
	                                <div>&nbsp</div>
	                                <label><strong>Tipo de comida</strong></label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="acai" <?php echo (in_array('acai', $_tipoComida)) ? 'checked' : '' ?>> Açaí
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="crepes" <?php echo (in_array('crepes', $_tipoComida)) ? 'checked' : '' ?>> Crepes
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="doces" <?php echo (in_array('doces', $_tipoComida)) ? 'checked' : '' ?>> Doces
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="fondue" <?php echo (in_array('fondue', $_tipoComida)) ? 'checked' : '' ?>> Fondue
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="hamburguers" <?php echo (in_array('hamburguers', $_tipoComida)) ? 'checked' : '' ?>> Hamburguers
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="iorgutes" <?php echo (in_array('iorgutes', $_tipoComida)) ? 'checked' : '' ?>> Iorgute
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="pasteis" <?php echo (in_array('pasteis', $_tipoComida)) ? 'checked' : '' ?>> Pasteis
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="pizzas" <?php echo (in_array('pizzas', $_tipoComida)) ? 'checked' : '' ?>> Pizzas
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="salgados" <?php echo (in_array('salgados', $_tipoComida)) ? 'checked' : '' ?>> Salgados
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="sanduiches" <?php echo (in_array('sanduiches', $_tipoComida)) ? 'checked' : '' ?>> Sanduiches
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="sorvete-picole" <?php echo (in_array('sorvete-picole', $_tipoComida)) ? 'checked' : '' ?>> Sorvetes / Picolés
	                                </label>
	                                </br>
	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="sushi-temaki" <?php echo (in_array('sushi-temaki', $_tipoComida)) ? 'checked' : '' ?>> Sushi / Temakis
	                                </label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoComida[]" value="outros" <?php echo (in_array('outros', $_tipoComida)) ? 'checked' : '' ?>> Outros
	                                </label>
	                            </div><!-- /span11 -->

	                            <div class="span11">
	                            	<?php $_tipoServico = explode(",", $res->tipo_servico_lanchonete); ?>
	                                <div>&nbsp</div>
	                                <label><strong>Tipo de Serviço</strong></label>

	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoServico[]" value="fast-food" <?php echo (in_array('fast-food', $_tipoServico)) ? 'checked' : '' ?>> Fast-food
	                                </label>
                            ...
                            <div class="span11">
                            	<?php $_adaptado = explode(",", $res->adaptado_lanchonete); ?>
                                <label class="checkbox inline">
					...
					<div class="widget-foot">
						<input type="hidden" name="id" value="<?php echo $res->id_lanchonete ?>">
						<input type="hidden" name="imgAtual" value="<?php echo $res->logo_lanchonete ?>">
						<input type="submit" class="btn btn-success pull-right" name="cadastrar" value="Atualizar lanchonete" />
