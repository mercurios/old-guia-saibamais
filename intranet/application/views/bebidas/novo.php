<div class="row">
	<form name="newbebida" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('bebidas/save') ?>">
		<div class="span12">
			<div class="widget">
				<div class="widget-head">
					<div class="pull-left"><i class="icon-plus"></i> Cadastrar bebidas</div>
				...
				<div class="widget-content padding-left-35">
					<div class="padd">
							<div class="row">
	                            ...
	                            <div class="span11">
	                                ...
	                                <label class="checkbox inline">
	                                    <input type="checkbox" id="inlineCheckbox1" name="tipoLocal[]" value="bebidas"> bebida
	                                </label>
					...
					<div class="widget-foot">
						<input type="submit" class="btn btn-success pull-right" name="cadastrar" value="Cadastrar bebida" />
