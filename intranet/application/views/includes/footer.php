        ...
        <div class="navbar navbar navbar-fixed-bottom navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
                    <div class="row">
                        <div class="span6">
                            <p></p>
                            <p class="muted">Todos os direitos reservados. 2013 - <?php echo date('Y') ?></p>
                        </div>

                        <div class="span6">
                            <p></p>
                            <p class="muted pull-right">Sistema desenvolvido pela <strong><a href="#" title="">Mercurios Soluções</a></strong></p>
                        </div>
                    </div>
                </div>
            </div>
