<div class="row">
	<form name="newRestaurante" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('eventos/save') ?>">
		<div class="span12">
			<div class="widget">
				<div class="widget-head">
					<div class="pull-left"><i class="icon-plus"></i> Cadastrar Eventos</div>
				...
				<div class="widget-content padding-left-35">
					...
					<div class="widget-foot">
						<input type="submit" class="btn btn-success pull-right" name="cadastrar" value="Cadastrar evento" />
