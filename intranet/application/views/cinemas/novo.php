<div class="row">
	<form name="newRestaurante" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('cinemas/save') ?>">
		<div class="span12">
			<div class="widget">
				...
				<div class="widget-content padding-left-35">
                                ...
                                <table class="table table-bordered table-striped">
									<thead>
										<tr class="info">
											...
											<td><strong><input class="input-block-level" name="t_1_cinema" type="text" placeholder="Inteira"></strong></td>
											<td><strong><input class="input-block-level" name="t_2_cinema" type="text" placeholder="Meia"></strong></td>
											<td><strong><input class="input-block-level" name="t_3_cinema" type="text" placeholder="3D"></strong></td>
											<td><strong><input class="input-block-level" name="t_4_cinema" type="text" placeholder="Meia 3D"></strong></td>
										</tr>
									</thead>
									...
									<tbody>
										<tr>
											...
											<td><input class="input-block-level" name="dom_1_cinema" type="text" placeholder="15,00"></td>
											<td><input class="input-block-level" name="dom_2_cinema" type="text" placeholder="11,00"></td>
											<td><input class="input-block-level" name="dom_3_cinema" type="text" placeholder="30,00"></td>
											<td><input class="input-block-level" name="dom_4_cinema" type="text" placeholder="15,00"></td>
										</tr>

										<tr>
											<td><strong>Segunda:</strong></td>
											<td><input class="input-block-level" name="seg_1_cinema" type="text" placeholder="15,00"></td>
											<td><input class="input-block-level" name="seg_2_cinema" type="text" placeholder="11,00"></td>
											<td><input class="input-block-level" name="seg_3_cinema" type="text" placeholder="30,00"></td>
											<td><input class="input-block-level" name="seg_4_cinema" type="text" placeholder="15,00"></td>
										</tr>

										<tr>
											<td><strong>Terça:</strong></td>
											<td><input class="input-block-level" name="ter_1_cinema" type="text" placeholder="15,00"></td>
											<td><input class="input-block-level" name="ter_2_cinema" type="text" placeholder="11,00"></td>
											<td><input class="input-block-level" name="ter_3_cinema" type="text" placeholder="30,00"></td>
											<td><input class="input-block-level" name="ter_4_cinema" type="text" placeholder="15,00"></td>
										</tr>

										<tr>
											<td><strong>Quarta:</strong></td>
											<td><input class="input-block-level" name="qua_1_cinema" type="text" placeholder="15,00"></td>
											<td><input class="input-block-level" name="qua_2_cinema" type="text" placeholder="11,00"></td>
											<td><input class="input-block-level" name="qua_3_cinema" type="text" placeholder="30,00"></td>
											<td><input class="input-block-level" name="qua_4_cinema" type="text" placeholder="15,00"></td>
										</tr>

										<tr>
											<td><strong>Quinta:</strong></td>
											<td><input class="input-block-level" name="qui_1_cinema" type="text" placeholder="15,00"></td>
											<td><input class="input-block-level" name="qui_2_cinema" type="text" placeholder="11,00"></td>
											<td><input class="input-block-level" name="qui_3_cinema" type="text" placeholder="30,00"></td>
											<td><input class="input-block-level" name="qui_4_cinema" type="text" placeholder="15,00"></td>
										</tr>

										<tr>
											<td><strong>Sexta:</strong></td>
											<td><input class="input-block-level" name="sex_1_cinema" type="text" placeholder="15,00"></td>
											<td><input class="input-block-level" name="sex_2_cinema" type="text" placeholder="11,00"></td>
											<td><input class="input-block-level" name="sex_3_cinema" type="text" placeholder="30,00"></td>
											<td><input class="input-block-level" name="sex_4_cinema" type="text" placeholder="15,00"></td>
										</tr>

										<tr>
											<td><strong>Sábado:</strong></td>
											<td><input class="input-block-level" name="sab_1_cinema" type="text" placeholder="15,00"></td>
											<td><input class="input-block-level" name="sab_2_cinema" type="text" placeholder="11,00"></td>
											<td><input class="input-block-level" name="sab_3_cinema" type="text" placeholder="30,00"></td>
											<td><input class="input-block-level" name="sab_4_cinema" type="text" placeholder="15,00"></td>
										</tr>

										<tr>
											<td><strong>Feriado:</strong></td>
											<td><input class="input-block-level" name="fer_1_cinema" type="text" placeholder="15,00"></td>
											<td><input class="input-block-level" name="fer_2_cinema" type="text" placeholder="11,00"></td>
											<td><input class="input-block-level" name="fer_3_cinema" type="text" placeholder="30,00"></td>
											<td><input class="input-block-level" name="fer_4_cinema" type="text" placeholder="15,00"></td>
										</tr>
									</tbody>
								</table>
                            </div>
					...
					<div class="widget-foot">
						<input type="submit" class="btn btn-success pull-right" name="cadastrar" value="Cadastrar cinema" />
