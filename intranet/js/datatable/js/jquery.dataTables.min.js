...
(function (i, wa, p) {
    ...
    o.oStdClasses = {
        ...
        sPageButtonActive: "paginate_active btn",
        sPageButtonStaticDisabled: "paginate_button paginate_button_disabled btn",
        sPageFirst: "first",
            ...
            fnUpdate: function (g, l) {
                if (g.aanFeatures.p) {
                    ...
                    for (s = x.length; r < s; r++) if (x[r].childNodes.length !== 0) {
                        ...
                        z = [
                            z[0], z[1], z[z.length - 2], z[z.length - 1]
                        ];
    ...
    i.fn.dataTable = function (g) {
        ...
        function Fa(a) {
                    ...
                    if (a.aoColumns[c].bSortable !== false) {
                        var e = function () {
                                ...
                                if (f.shiftKey) {
                                    ...
                                    k === false && a.aaSorting.push([
                                        c, a.aoColumns[c].asSorting[0], 0
                                    ])
            ...
            function Ca(a) {
                if (a.oScroll.bInfinite) return null;
                var b = '<select size="1" class="span2" ' + (a.sTableId === "" ? "" : 'name="' + a.sTableId + '_length"') + ">",
                    c,
                    d;
            ...
            this.fnClose = function (a) {
                for (var b = A(this[o.iApiIndex]), c = 0; c < b.aoOpenRows.length; c++) if (b.aoOpenRows[c].nParent == a) {(a = b.aoOpenRows[c].nTr.parentNode) && a.removeChild(b.aoOpenRows[c].nTr);
            ...
            this.fnGetPosition = function (a) {
                ...
                if (c == "TR") return U(b, a);
                    ...
                    c = U(b, a.parentNode);
                    for (var d = Q(b, c), f = 0; f < b.aoColumns.length; f++) if (d[f] == a) return [
                        c, pa(b, f), f
                    ]
                }
                return null
            ...
            this.fnDestroy = function () {
                ...
                if (a.bJUI) {
                    i("th", a.nTHead).removeClass([
                        o.oStdClasses.sSortable, o.oJUIClasses.sSortableAsc, o.oJUIClasses.sSortableDesc, o.oJUIClasses.sSortableNone
                    ].join(" "));
                ...
                } else i("th", a.nTHead).removeClass([
                    o.oStdClasses.sSortable, o.oStdClasses.sSortableAsc, o.oStdClasses.sSortableDesc, o.oStdClasses.sSortableNone
                ].join(" "));
